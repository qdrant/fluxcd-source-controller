...
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=buckets,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=buckets/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=buckets/finalizers,verbs=get;create;update;patch;delete
