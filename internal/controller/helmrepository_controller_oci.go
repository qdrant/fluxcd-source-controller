...
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=helmrepositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=helmrepositories/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=helmrepositories/finalizers,verbs=get;create;update;patch;delete
