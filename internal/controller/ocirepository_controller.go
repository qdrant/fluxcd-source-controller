...
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=ocirepositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=ocirepositories/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=flux.cd.qdrant.io,resources=ocirepositories/finalizers,verbs=get;create;update;patch;delete
